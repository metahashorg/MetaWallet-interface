...
extendFunction(DAppsView, View);

DAppsView.prototype.onStarted = function () {
    /** @type {HTMLElement} */
...
DAppsView.prototype.onShown = function () {
    this.pageWrapper.scrollTop = 0;
};

DAppsView.prototype.onStopped = function () {
 ...
 * @param {Event} e
 */
DAppsView.prototype.onScroll = function (e) {
    // console.log(e);
    // reinit
...
DAppsView.prototype.loadDApps = function () {
    // console.log("DAppsView.loadDApps");

    apiXhr(getJsonRpcXhrParams("dapps.list", {params: [{offset: this._offset, limit: this._limit}]}))
 ...
 */
DAppsView.prototype.searchDApps = function (event) {
...
DAppsView.prototype.clearDAppSubViews = function () {
...
DAppsView.prototype.drawDAppSubViews = function () {
 ...
 * @return {DAppSubView}
 */
DAppsView.prototype.getDAppSubView = function (dapp) {
    ...
    /** @type {DAppSubView} */
    let dappSubView = new DAppSubView({app: this.app, element: template, dapp: dapp});
    dappSubView.start();
