 ...
 * @constructor
 */
function PasscodeSettingsView (config) {
...
extendFunction(PasscodeSettingsView, View);

PasscodeSettingsView.prototype.onStarted = function () {
...
PasscodeSettingsView.prototype.updateUi = function () {
...
PasscodeSettingsView.prototype.turnOnPasscode = function () {
    this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, title: "passcodemodalview.title.new", editMode: true}), FLAGS_APP_PUSHVIEW_MODAL_FADEIN)
        .then(function (/** @type {string} */ passcode) {
            ...
            this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, title: "passcodemodalview.title.repeat", editMode: true}), FLAGS_APP_PUSHVIEW_MODAL_SHOW)
                .then(function (/** @type {string} */ passcode) {
                    console.log("++", passcode);
...
PasscodeSettingsView.prototype.turnOffPasscode = function () {
    this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, autoFaceId: true}), FLAGS_APP_PUSHVIEW_MODAL_FADEIN)
        .then(function () {
            this.app.prevView(FLAGS_APP_PUSHVIEW_MODAL_FADEIN);
            this.app.showNotification({text: __("settings.passcode.turnedoff"), type: NOTIFICATION_SUCCESS});
...
PasscodeSettingsView.prototype.changePasscode = function () {
    this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, autoFaceId: true}), FLAGS_APP_PUSHVIEW_MODAL_FADEIN)
        .then(function () {
            this.app.prevView(FLAGS_APP_PUSHVIEW_MODAL_SHOW);

            this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, title: "passcodemodalview.title.new", editMode: true}), FLAGS_APP_PUSHVIEW_MODAL_SHOW)
                .then(function (/** @type {string} */ passcode) {
                    console.log("+", passcode);
                    this.app.prevView(FLAGS_APP_PUSHVIEW_MODAL_SHOW);
                    ...
                    this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app, title: "passcodemodalview.title.repeat", editMode: true}), FLAGS_APP_PUSHVIEW_MODAL_SHOW)
                        .then(function (/** @type {string} */ passcode) {
                            ...
                            this.app.showNotification({text: __("settings.passcode.changed"), type: NOTIFICATION_SUCCESS});
                            this.app.settings.set("passcode.passcode", passcode);
                        }.bind(this))
                        .catch(function () {
                            this.app.prevView(FLAGS_APP_PUSHVIEW_MODAL_FADEIN);
 ...
 */
PasscodeSettingsView.prototype.onCheckboxChanged = function (params) {
    if (!params.value) { // check passcode to turn off
        this.app.pushView(new PasscodeAlertView(/** @type {ViewConfig} */ {app: this.app}), FLAGS_APP_PUSHVIEW_MODAL_FADEIN)
            .then(function () {
                this.app.prevView(FLAGS_APP_PUSHVIEW_MODAL_FADEIN);
