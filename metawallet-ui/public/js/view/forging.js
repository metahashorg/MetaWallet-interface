...
extendFunction(ForgingView, View);

ForgingView.prototype.onStarted = function () {
    ...
    this.element.qs("actions.delegations").onclick = function () {
        this.app.pushView(new DelegationsView(/** @type {ViewConfig} */ {app: this.app, wallet: this.wallet}));
    }.bind(this);
 ...
 * @param {Event} e
 */
ForgingView.prototype.onScroll = function (e) {
...
ForgingView.prototype.onShown = function () {
    this.wallet.getRewards();
};

ForgingView.prototype.onStopped = function () {
...
ForgingView.prototype.clearTransactionSubViews = function () {
...
ForgingView.prototype.drawTransactionSubViews = function () {
    this.clearTransactionSubViews();
 ...
 */
ForgingView.prototype.getTransactionSubView = function (transaction) {
    /** @type {HTMLElement} */
