...
extendFunction(WalletsView, View);
...
WalletsView.prototype.onStarted = function () {
...
WalletsView.prototype.onStopped = function () {
...
WalletsView.prototype.onShown = function () {
    this.headerSubView.update();
...
WalletsView.prototype.onBeforeHidden = function () {
...
WalletsView.prototype.initTabs = function () {
...
WalletsView.prototype.clearWalletSubViews = function () {
...
WalletsView.prototype.drawWalletSubViews = function () {
    this.clearWalletSubViews();
...
WalletsView.prototype.updateWalletSubViews = function () {
 ...
 */
WalletsView.prototype.getWalletSubView = function (wallet) {
    /** @type {HTMLElement} */
    let template = this._walletTemplate.cloneNode(true);
    template.removeAttribute("data-selector");

    /** @type {WalletSubView} */
    let walletSubView = new WalletSubView({app: this.app, element: template, wallet: wallet});
    walletSubView.start();
...
WalletsView.prototype.clearTransactionSubViews = function () {
 ...
 */
WalletsView.prototype.drawTransactionSubViews = function (transactions) {
    if (!transactions) {
        this.clearTransactionSubViews();
 ...
 */
WalletsView.prototype.getTransactionSubView = function (transaction) {
    /** @type {HTMLElement} */
    let template = this._transactionTemplate.cloneNode(true);
    template.removeAttribute("data-selector");

    /** @type {TransactionSubView} */
    let transactionSubView = new TransactionSubView({app: this.app, element: template, transaction: transaction, currencyId: this.currencyId});
    transactionSubView.start();

    return transactionSubView;
};

WalletsView.prototype.onCreateWalletClicked = function () {
    this.app.alertView(new WalletCreateAlertView(/** @type {ViewConfig} */ {app: this.app, currencyId: this.currencyId}))
        .then(function (/** @type {Wallet} */ wallet) {
            this.app.walletCollection.load(true);
            this.app.prevView()
                .then(function () {
                    this.app.pushView(new WalletView(/** @type {ViewConfig} */ {app: this.app, wallet: wallet}));
                }.bind(this));
        }.bind(this))
        .catch(function () {
        }.bind(this));
