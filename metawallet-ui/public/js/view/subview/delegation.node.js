 ...
 * @constructor
 */
function DelegationNodeSubView (config) {
...
extendFunction(DelegationNodeSubView, View);

DelegationNodeSubView.prototype.onStarted = function () {
    this.element.querySelector(".delegation-log-info-button").onclick = function () {
        showUnDelegate(this.app, {node: this.node, delegation: this.delegation});
    }.bind(this);
};

DelegationNodeSubView.prototype.onShown = function () {
    this.update();
};

DelegationNodeSubView.prototype.update = function () {
