...
extendFunction(NodesView, View);

NodesView.prototype.onStarted = function () {
...
NodesView.prototype.onStopped = function () {
 ...
 * @param {Event} e
 */
NodesView.prototype.onScroll = function (e) {
...
NodesView.prototype.loadNodes = function () {
 ...
 */
NodesView.prototype.searchNodes = function (event) {
...
NodesView.prototype.clearNodesSubViews = function () {
...
NodesView.prototype.drawNodesSubViews = function () {
    this.clearNodesSubViews();
 ...
 * @return {NodeSubView}
 */
NodesView.prototype.getNodeSubView = function (node) {
    ...
    /** @type {NodeSubView} */
    let nodeSubView = new NodeSubView({app: this.app, element: template, node: node});
    nodeSubView.start();
