 ...
 * @constructor
 */
function DelegationsView (config) {
...
extendFunction(DelegationsView, View);

DelegationsView.prototype.onStarted = function () {
    ...
    this.element.qs("actions.allnodes").onclick = function () {
        this.app.pushView(new NodesView(/** @type {ViewConfig} */ {app: this.app}));
    }.bind(this);
 ...
 * @param {Event} e
 */
DelegationsView.prototype.onScroll = function (e) {
...
DelegationsView.prototype.onShown = function () {
    this.walletCardSubView.show();
};

DelegationsView.prototype.onStopped = function () {
...
DelegationsView.prototype.update = function () {
    this.walletCardSubView.update();
};

DelegationsView.prototype.clearDelegationSubViews = function () {
...
DelegationsView.prototype.drawDelegationSubViews = function () {
    this.clearDelegationSubViews();
 ...
 */
DelegationsView.prototype.getDelegationSubView = function (delegation) {
    /** @type {HTMLElement} */
    let template = this._delegationsTemplate.cloneNode(true);
    template.removeAttribute("data-selector");

    /** @type {DelegationSubView} */
    let delegationSubView = new DelegationSubView({app: this.app, element: template, delegation: delegation, wallet: this.wallet});
