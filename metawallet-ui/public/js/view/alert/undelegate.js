 ...
 * @constructor
 */
function UndelegateAlertView (config) {
...
extendFunction(UndelegateAlertView, View);

UndelegateAlertView.prototype.onStarted = function () {
 ...
 * @param {string} error
 */
UndelegateAlertView.prototype.showError = function (error) {
    this.errorElement.innerHTML = __("metapayalertview.error." + error);
    this.errorElement.show();
};

UndelegateAlertView.prototype.hideError = function () {
    this.errorElement.hide();
};

UndelegateAlertView.prototype.onWalletsLoaded = function () {
    let wallets = this.app.walletCollection.getWalletsSortedByTime(this.currencyId);
    if (wallets.length) {
        this.hideError();
...
UndelegateAlertView.prototype.onWalletSelect = function () {
 ...
 * @param {Wallet} wallet
 */
UndelegateAlertView.prototype.onWalletSelected = function (wallet) {
    this.wallet = wallet;
...
UndelegateAlertView.prototype.onContinueClicked = function () {
