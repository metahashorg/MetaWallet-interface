 ...
 * @constructor
 */
function WalletImportEncryptedAlertView (config) {
...
extendFunction(WalletImportEncryptedAlertView, View);

WalletImportEncryptedAlertView.prototype.onStarted = function () {
    /** @type {HTMLElement|xD} */
...
WalletImportEncryptedAlertView.prototype.onImportWalletClicked = function () {
    if (this.loader) {
        return;
    }
    ...
    cryptoWorker.postMessage({currencyId: this.wallet.currencyId, encryptedWallet: this.encryptedWallet, password: formData["password"]});
};
