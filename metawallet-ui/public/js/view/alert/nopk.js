...
extendFunction(NoPkAlertView, View);

NoPkAlertView.prototype.onStarted = function () {
    this.element.qs("actions.import").onclick = function () {
        importPk(this.app, this.wallet)
            ...
            .catch(function () {
                this.app.prevView();
                this.app.showNotification({text: __("error.wrongqrcode"), type: NOTIFICATION_ERROR});
            }.bind(this));
    }.bind(this);
