...
extendFunction(TermsView, View);

TermsView.prototype.onStarted = function () {
    ...
    this.button.onclick = function () {
        if (!this.checkbox.checked) {
            this.app.showNotification({text: __("termsview.needagree"), type: NOTIFICATION_ERROR, hideTimeout: UI_ERROR_NOTIFICATION_LONG_TIMEOUT * 1000});
            return;
        }
        this.app.pushView(new CreateAccountView(/** @type {ViewConfig} */ {app: this.app}));
    }.bind(this);
};

TermsView.prototype.onStopped = function () {
